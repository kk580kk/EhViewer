...
public class HistoryDao extends AbstractDao<HistoryInfo, Long> {
    ...
    @Override
    protected HistoryInfo readEntity(Cursor cursor, int offset) {
        ...
        entity.mode = cursor.getInt(offset + 10);
        entity.time = cursor.getLong(offset + 11);
        return entity;
    }

    @Override
    protected void bindValues(ContentValues values, HistoryInfo entity) {
    ...
    @Override
    protected Long getKey(HistoryInfo entity) {
        return entity.gid;
    }

    @Override
    protected boolean hasKey(HistoryInfo entity) {
        return true;
    }
}
