...
public class LocalFavoritesDao extends AbstractDao<LocalFavoriteInfo, Long> {
    ...
    public LocalFavoritesDao(SQLiteDatabase db) {
        super(db);
    }

    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        String constraint = ifNotExists ? "IF NOT EXISTS " : "";
        db.execSQL("CREATE TABLE " + constraint + "\"LOCAL_FAVORITES\" (" +
    ...
    @Override
    protected LocalFavoriteInfo readEntity(Cursor cursor, int offset) {
        LocalFavoriteInfo entity = new LocalFavoriteInfo();
        ...
        entity.time = cursor.getLong(offset + 10);
        return entity;
    }

    @Override
    protected void bindValues(ContentValues values, LocalFavoriteInfo entity) {
    ...
    @Override
    protected Long getKey(LocalFavoriteInfo entity) {
        return entity.gid;
    }

    @Override
    protected boolean hasKey(LocalFavoriteInfo entity) {
        return true;
    }
}
