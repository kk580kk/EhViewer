...
set CLASSPATH=%APP_HOME%\lib\desktop.jar;%APP_HOME%\lib\jsoup-1.12.1.jar;%APP_HOME%\lib\okhttp-3.12.3.jar;%APP_HOME%\lib\okio-1.15.0.jar

@rem Execute desktop
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DESKTOP_OPTS%  -classpath "%CLASSPATH%" com.hippo.desktop.Main %CMD_LINE_ARGS%
